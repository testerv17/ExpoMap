...
(() => {
  const MAP_IMG = './assets/plano.png';
...
function openStand(id){
  ...
  els.mDesc.textContent = st.description || 'Descripción pendiente.';
  els.mNote.textContent = st.note || '';
  ...
  // MUY IMPORTANTE: mostrar modal y bloquear scroll
...
document.querySelector('.modalCard')?.addEventListener('click', (e) => {
  e.stopPropagation();
});
